-- ============================================
-- MIGRATION: Add Built-in Automations System
-- ============================================
-- Run this script to add built-in automations support to your database
-- You can run this via Docker or directly in PostgreSQL
...
-- Now insert all 11 built-in automation templates
-- These will be ignored if they already exist (ON CONFLICT DO NOTHING)

-- 1. Forward Voice Messages
...
SELECT COUNT(*) as total_templates FROM builtin_automations;
